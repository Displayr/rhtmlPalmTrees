...
class VerticalBottomToTopWrappedLabel extends BaseComponent {
  ...
  draw ({ container: parentContainer, bounds, onClick }) {
    ...
    this.textSelection = this.container.append('text')
      .attr('transform', `translate(${bounds.width / 2}, ${bounds.height}),rotate(-90)`)
      .attr('x', 0)
      .attr('y', 0)
      .attr('dy', 0)
  ...
  applyHorizontalZoom ({ newCellWidth, xOffset, inZoom }) {
    ...
    this.textSelection
      .attr('transform', `translate(${newCellWidth / 2}, ${this.bounds.height}),rotate(-90)`)
  ...
  resetHorizontalZoom ({ xOffset }) {
    ...
    this.textSelection
      .attr('transform', `translate(${this.bounds.width / 2}, ${this.bounds.height}),rotate(-90)`)
